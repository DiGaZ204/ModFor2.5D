...
def find_and_click_icon(icon_path, confidence=0.8, max_attempts=20, delay=0.5):
    """
    找到螢幕上的圖示並點擊，如果失敗則重試
    """
...
def click_images_in_sequence(image_paths, max_attempts=20, delay=0.5):
    """
    依序點擊多張圖片
    """
...
def click_until_next_image(click_coords, next_image_path, max_attempts=33, delay=0.3):
    """
